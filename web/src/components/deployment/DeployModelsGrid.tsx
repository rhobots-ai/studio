...
// Extended ModelInfo with path property
...
interface DeployModelsGridProps {
  models: DeployModelInfo[];
  onSelectModel: (model: DeployModelInfo) => void;
  selectedModelId?: string;
  filterType?: 'all' | 'base' | 'fine-tuned';
}

export function DeployModelsGrid({ 
  models, 
  onSelectModel, 
  selectedModelId,
  filterType = 'all'
}: DeployModelsGridProps) {
